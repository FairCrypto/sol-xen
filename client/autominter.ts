...
import {AnchorProvider, Program, Provider, setProvider, utils, Wallet, web3, workspace} from "@coral-xyz/anchor";
import NodeWallet from "@coral-xyz/anchor/dist/cjs/nodewallet";

import {SolXenMinter} from '../target/types/sol_xen_minter';
import {ComputeBudgetProgram, PublicKey, TransactionExpiredTimeoutError} from "@solana/web3.js";
...
export type AutoMinterParams = {
    kind: number;
    autoMint: number;
    priorityFee: number;
    minerProgramId: string;
    startSlot: number;
}

let currentRun = 1;
const { kind = 1, autoMint, minerProgramId: pidStr, priorityFee, startSlot } = workerData as AutoMinterParams || {};
